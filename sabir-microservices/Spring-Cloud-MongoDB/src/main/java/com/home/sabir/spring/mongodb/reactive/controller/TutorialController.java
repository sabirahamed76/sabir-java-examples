package com.home.sabir.spring.mongodb.reactive.controller;
...
import com.home.sabir.spring.mongodb.reactive.model.Tutorial;
import com.home.sabir.spring.mongodb.reactive.service.TutorialService;
...
public class TutorialController {
  ...
  public Mono<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
    return tutorialService.save(new Tutorial(tutorial.getTitle(), tutorial.getDescription(), tutorial.getPublished()));
  }
