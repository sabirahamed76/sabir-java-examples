...
public class ComparatorDemo {
 public static void main(String[] args)
 {
     ...
     list.add(new Movie("Revenant", 8.0, 2015));
     list.add(new Movie("Mad Max: Fury Road", 8.1, 2015));
     list.add(new Movie("Inside Out", 8.2, 2015));
     list.add(new Movie("Big Short", 7.9, 2015));
