...
public class StreamDemo {
	...
	public static void main(String[] args) {
        ...
        streamDemo4ListOfList();

        parallelStreamDemo4List();
    ...
    private static void streamDemo4List(){
        ...
        List<Double> filteredNumbers = ascSortedNumbers.stream()
                .filter(a -> a > 3)   // Filter only numbers greater than 3 using Stream
                .collect(Collectors.toList());
        ...
        double sum = squaredNumbers.stream()
                .reduce(0.0, Double::sum);  //Reducing: calculate sum
    ...
    private static void streamDemo4Map(){
    ...
    private static void streamDemo4ListOfList(){
        ...
        System.out.println();
        System.out.println("==========================");
        System.out.println("equals: Check if State exists");
    ...
    private static void parallelStreamDemo4List() {
        //Parrallel Stream is multi threaded
    ...
    private static void streamDemo4Object(){
        ...
        productsList.add(new Product(5, "HP Laptop", 30000f));
        productsList.add(new Product(6, "Apple Laptop", 40000f));
        productsList.add(new Product(7, "HP Laptop", 50000f));
        productsList.add(new Product(8, "Dell Laptop", 60000f));
        productsList.add(new Product(9, "Dell Laptop", 70000f));
	...
	private static void withStreamAPI() {
       ...
       // Using Collectors's method to sum the prices.          
        ...
        //another method
        totalPrice3 = productsList.stream()
        ...
        Map<String, Long> productCount = productsList.stream()
