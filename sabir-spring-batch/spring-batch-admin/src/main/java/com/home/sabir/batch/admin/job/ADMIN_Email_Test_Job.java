...
@Configuration
@Lazy
public class ADMIN_Email_Test_Job {
	
	private static final Logger logger = LogManager.getLogger(ADMIN_Email_Test_Job.class);
	@Autowired
	...
	public Job ADMIN_Email_Test (){
		...
		return jobBuilderFactory.get("ADMIN_Email_Test").incrementer(new RunIdIncrementer())
				.start(test_email())
				.build();
