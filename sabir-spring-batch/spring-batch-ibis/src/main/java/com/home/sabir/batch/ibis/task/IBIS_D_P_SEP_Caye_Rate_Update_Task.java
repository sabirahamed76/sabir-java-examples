...
import com.home.sabir.batch.ibis.service.IBIS_D_P_SEP_Caye_Rate_Info_Extractor_Service;
import com.home.sabir.batch.ibis.service.IBIS_D_P_SEP_Caye_Rate_Info_Service;
import com.home.sabir.batch.ibis.service.IBIS_D_P_SEP_Caye_Rate_Info_Upd_Admin_Txn_Extractor_Service;

public class IBIS_D_P_SEP_Caye_Rate_Update_Task implements Tasklet {

	private static final Logger logger = LogManager.getLogger(IBIS_D_P_SEP_Caye_Rate_Update_Task.class);
	...
	public IBIS_D_P_SEP_Caye_Rate_Update_Task(DataSource dataSource, IBIS_D_P_SEP_Caye_Rate_Info_Service cayeRateInfoService,
			String transDate) {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		Long totalRecCount = jdbcTemplate.query(selectCayeRateUpdateRetrieveSql, sqlParameters, 
				new IBIS_D_P_SEP_Caye_Rate_Info_Extractor_Service(cayeRateInfoService, dataSource,transDate));
		...
		totalRecCount = jdbcTemplate.query(selectCayeRateUpdateAdminRetrieveSql, sqlParameters, 
				new IBIS_D_P_SEP_Caye_Rate_Info_Upd_Admin_Txn_Extractor_Service(cayeRateInfoService, dataSource, transDate));
