...
public class IBIS_D_P_SEP_Caye_Rate_Info_Upd_Admin_Txn_Extractor_Service implements ResultSetExtractor<Long> {

	private static final Logger logger = LogManager.getLogger(IBIS_D_P_SEP_Caye_Rate_Info_Upd_Admin_Txn_Extractor_Service.class);

	private IBIS_D_P_SEP_Caye_Rate_Info_Service service;
	private DataSource dataSource;
	private String transDate;

	public IBIS_D_P_SEP_Caye_Rate_Info_Upd_Admin_Txn_Extractor_Service(IBIS_D_P_SEP_Caye_Rate_Info_Service service, DataSource dataSource, String transDate) {
