...
public class IBISBatchApplication implements CommandLineRunner {
	...
	private static final Logger logger = LogManager.getLogger(IBISBatchApplication.class);

	public static void main(String[] args) {
		logger.info("Batch Process Started");
 		try{
 			SpringApplication.run(IBISBatchApplication.class, args);
